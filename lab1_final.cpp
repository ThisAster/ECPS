...
void play_animation() {
    for (int i = 0; i < 8; i++) {
		if (i < 6) {
            ...
            HAL_GPIO_WritePin(GPIOD, leds_num[6 - i], GPIO_PIN_SET);
            HAL_GPIO_WritePin(GPIOD, leds_num[6 - i + 6], GPIO_PIN_SET);
			HAL_GPIO_WritePin(GPIOD, leds_num[6 - i + 7], GPIO_PIN_SET);

			HAL_Delay(delay);	

            HAL_GPIO_WritePin(GPIOD, leds_num[6 - i], GPIO_PIN_RESET);
            HAL_GPIO_WritePin(GPIOD, leds_num[6 - i + 6], GPIO_PIN_RESET);
			HAL_GPIO_WritePin(GPIOD, leds_num[6 - i + 7], GPIO_PIN_RESET);
            ...
            HAL_GPIO_WritePin(GPIOD, leds_num[7 - i + 1], GPIO_PIN_SET);
			HAL_GPIO_WritePin(GPIOD, leds_num[i], GPIO_PIN_SET);

            HAL_Delay(delay);

            HAL_GPIO_WritePin(GPIOD, leds_num[7 - i], GPIO_PIN_RESET);
            HAL_GPIO_WritePin(GPIOD, leds_num[7 - i + 1], GPIO_PIN_RESET);
			HAL_GPIO_WritePin(GPIOD, leds_num[i], GPIO_PIN_RESET);
